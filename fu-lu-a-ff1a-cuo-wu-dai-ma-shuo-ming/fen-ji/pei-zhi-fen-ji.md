...
**请求地址：**[https://192.168.5.150:8088/api/](https://192.168.5.150:8088/api/v1.0.0/extension/update?token=7d20390952e15eb72b0a1df7172de65c){version}[/extension/update?token=7d20390952e15eb72b0a1df7172de65c](https://192.168.5.150:8088/api/v1.0.0/extension/update?token=7d20390952e15eb72b0a1df7172de65c)
...
| 参数名称 | 类型 | 参数说明 | 参数值举例 |
| :--- | :--- | :--- | :--- |
| &lt;extid&gt; | int | 要进行配置的分机的分机号 | 1001 |
| \[extnumber\] | int | 修改后的分机号 | 1000 |
...
| \[atransferext\] | string | 目的地为分机时的分机号 | 3002 |
...
| \[ntransferext\] | string | 目的地为分机时的分机号 | 3002 |
...
| \[btransferext\] | string | 目的地为分机时的分机号 | 3002 |
